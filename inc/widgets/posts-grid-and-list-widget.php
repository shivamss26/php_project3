<?php
if ( ! class_exists( 'Instant_News_Posts_Grid_And_List_Widget' ) ) {
	/**
	 * Adds Instant_News_Posts_Grid_And_List_Widget Widget.
	 */
	class Instant_News_Posts_Grid_And_List_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$instant_news_grid_list_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-grid-list-section style-1',
				'description' => __( 'Retrive Posts Grid And List Widgets', 'instant-news' ),
			);
			parent::__construct(
				'instant_news_grid_list_widget',
				__( 'Ascendoor Grid And List Widget', 'instant-news' ),
				$instant_news_grid_list_widget_ops
			);
		}
