<?php
if ( ! class_exists( 'Instant_News_Posts_List_Widget' ) ) {
	/**
	 * Adds Instant_News_Posts_List_Widget Widget.
	 */
	class Instant_News_Posts_List_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct(
				'instant_news_list_widget',
				__( 'Ascendoor Posts List Widget', 'instant-news' ),
