<?php
if ( ! class_exists( 'Instant_News_Posts_Small_List_Widget' ) ) {
	/**
	 * Adds Instant_News_Posts_Small_List_Widget Widget.
	 */
	class Instant_News_Posts_Small_List_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$instant_news_list_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-small-list-section style-1',
				'description' => __( 'Retrive Posts List Widgets', 'instant-news' ),
			);
			parent::__construct(
				'instant_news_small_list_widget',
				__( 'Ascendoor Posts Small List Widget', 'instant-news' ),
				$instant_news_list_widget_ops
			);
		}
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of posts to show(Min:1 | Max:8):', 'instant-news' ); ?></label>
