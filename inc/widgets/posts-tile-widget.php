<?php
if ( ! class_exists( 'Instant_News_Posts_Tile_Widget' ) ) {
	/**
	 * Adds Instant_News_Posts_Tile_Widget Widget.
	 */
	class Instant_News_Posts_Tile_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$instant_news_tile_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-tile-section style-1',
				'description' => __( 'Retrive Posts Tile Widgets', 'instant-news' ),
			);
			parent::__construct(
				'instant_news_tile_widget',
				__( 'Ascendoor Posts Tile Widget', 'instant-news' ),
				$instant_news_tile_widget_ops
			);
		}
